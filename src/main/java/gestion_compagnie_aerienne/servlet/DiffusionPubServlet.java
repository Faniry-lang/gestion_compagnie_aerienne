...
public class DiffusionPubServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            Double ca = PayementPub.getCA(idSociete, date);
            ...
            req.getRequestDispatcher("pages/diffusion-pub/diffusion-pub-list.jsp").forward(req, resp);
        } catch (Exception e) {
