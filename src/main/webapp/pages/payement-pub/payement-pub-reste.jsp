...
<head>
    <meta charset="UTF-8">
    <title>Reste à Payer Publicités</title>
    ...
    <style>
        ...
        .reste-display { margin-top: 20px; padding: 20px; background: #f8fafc; border-radius: 8px; text-align: center; }
        .reste-display h2 { margin: 0; color: #0f172a; }
...
<div class="main-content">
    ...
    <div class="page-header">
        <h1>Reste à Payer Publicités</h1>
    ...
    <div class="reste-display">
        <h2>Reste à Payer: <%= reste != null ? String.format("%.2f", reste) : "0.00" %> Ar</h2>
    </div>
...
<div id="filterPanel" class="filter-panel">
    ...
    <form action="payement-pub" method="get">
        <label>Société</label>
